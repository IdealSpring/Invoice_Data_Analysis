...
//    private String redOutputInvoiceAmountRate = "Null";
    ...
    public String toString() {
        return nsr_id +
                ...
                "," + lossAddStock + "," + redInvoiceQuantityRate +
                "," + numberDifferenceOfInputAndOutput +
                "," + valueOfRedInovice + "," + label;
    }
    ...
    public void write(DataOutput dataOutput) throws IOException {
        ...
        dataOutput.writeUTF(this.redInvoiceQuantityRate);
        dataOutput.writeUTF(this.numberDifferenceOfInputAndOutput);
        dataOutput.writeUTF(this.valueOfRedInovice);
    ...
    public void readFields(DataInput dataInput) throws IOException {
        ...
        this.redInvoiceQuantityRate = dataInput.readUTF();
		this.numberDifferenceOfInputAndOutput = dataInput.readUTF();
        this.valueOfRedInovice = dataInput.readUTF();
    ...
    public String getRedInvoiceQuantityRate() {
        return redInvoiceQuantityRate;
    }

    public void setRedInvoiceQuantityRate(String redInvoiceQuantityRate) {
        this.redInvoiceQuantityRate = redInvoiceQuantityRate;
    }

    public String getValueOfRedInovice() {
        return valueOfRedInovice;
    }

    public void setValueOfRedInovice(String valueOfRedInovice) {
        this.valueOfRedInovice = valueOfRedInovice;
    }
