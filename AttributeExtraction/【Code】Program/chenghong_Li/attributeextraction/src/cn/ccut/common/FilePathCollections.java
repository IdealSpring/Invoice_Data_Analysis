...
public class FilePathCollections {
    ...
    public static final String basePath = "F:\\Desktop\\IBAAttributeExtraction\\异常企业资料\\";
     ...
     */
    //结果输出路径
    public static final String stage01ResultOutputPath = basePath + "result/AttributeList";
     ...
     */
    //结果输出路径
    public static final String IdOutputPath = basePath + "result/";

    /**
     * 交叉验证文件输出路径
     */
    public static final String stage05CrossValidationPath = basePath + "result/CrossValidationData";

    /**
     * HDFS文件系统中，存储训练集和测试集路径
     */
    public static final String stage06HDFSTrainAndTestPath = "/user/hadoop/mahout_ChauncyLi";
