...
public class Enterprise implements Writable{
    ...
    public String getRedInputInvoiceAmountRate() {
        return redInputInvoiceAmountRate;
    }

    public void setRedInputInvoiceAmountRate(String redInputInvoiceAmountRate) {
        this.redInputInvoiceAmountRate = redInputInvoiceAmountRate;
    }

    public String getRedOutputInvoiceAmountRate() {
        return redOutputInvoiceAmountRate;
    }
