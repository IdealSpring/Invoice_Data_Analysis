...
//                                enterprise.setInputInterval("withinOneMonth");
                                enterprise.setInputInterval("1");
                            } else if(time3 <= 60) {
//                                enterprise.setInputInterval("withinTwoMonth");
                                enterprise.setInputInterval("2");
                            } else {
//                                enterprise.setInputInterval("withoutMonth");
                                enterprise.setInputInterval("0");
                            }
                        }
                    }
                } else {
...
//            enterprise.setInputInterval("withoutInvoice");
            enterprise.setInputInterval("100");
        }
    }
    ...
    public static void setOutputInterval(Enterprise enterprise, TreeSet<Invoice> outputInvoiceSet) {
        if(outputInvoiceSet.size() > 0) {
                ...
                if(first.getKprq().compareTo(last.getKprq()) != 0) {
                    for(Invoice invoice1 : outputInvoiceSet) {
                        ...
                        if(invoice2 == null) {
                            ...
                            if(time3 <= 30) {
                                enterprise.setOutputInterval("1");
                            } else if(time3 <= 60) {
                                enterprise.setOutputInterval("2");
                            } else {
                                enterprise.setOutputInterval("0");
                            }
                        }
                    }
                } else {
            ...
            enterprise.setOutputInterval("100");
        }
    }
...
//                      enterprise.setInvoiceUsageChange("high");
                        enterprise.setInvoiceUsageChange("1");
                    } else {
...
//                    enterprise.setInvoiceUsageChange("none");
                    enterprise.setInvoiceUsageChange("0");
                }
...
//                            enterprise.setInputTaxAndOutputTaxRatio("high");
                            enterprise.setInputTaxAndOutputTaxRatio("1");
                        } else {
...
//                        enterprise.setInputTaxAndOutputTaxRatio("none");
                        enterprise.setInputTaxAndOutputTaxRatio("0");
                    }
...
//                    enterprise.setInvoiceInvalidRatio("none");
    ...
    public static void setContinuousLoss(Enterprise enterprise, TreeSet<Invoice> inputInvoiceSet, TreeSet<Invoice> outputInvoiceSet) {
        ...
        if ( inum <= 0 || onum <= 0 || (inum <= 0 && onum <= 0)) {
             enterprise.setContinuousLoss("100");
        }
...
//                    enterprise.setContinuousLoss("continuousMonth");
                    enterprise.setContinuousLoss("1");
                } else {
//                    enterprise.setContinuousLoss("none");
                    enterprise.setContinuousLoss("0");
                }
            } else {
                // 计算总进项金额
                for (Invoice invoice : inputList) {
...
//                    enterprise.setContinuousLoss("overallLoss");
                    enterprise.setContinuousLoss("2");
                } else {
                    enterprise.setContinuousLoss("0");
                }
            }
    ...
    public static void setInvoiceBalance(Enterprise enterprise, TreeSet<Invoice> inputInvoiceSet, TreeSet<Invoice> outputInvoiceSet){
        ...
        // 若进销项有一项不存在, 设值unknown
        if ( inum <= 0 || onum <= 0 || (inum <= 0 && onum <= 0)) {
            enterprise.setInvoiceBalance("100");
        }
...
//            enterprise.setInvoiceBalance("balanceHuge");//差额巨大
            enterprise.setInvoiceBalance("1");//差额巨大
        } else {
//            enterprise.setInvoiceBalance("normal");//差额正常
            enterprise.setInvoiceBalance("0");//差额正常
        }
    }
...
//                enterprise.setInputInvoiceInvalid("exist");
                enterprise.setInputInvoiceInvalid("1");
                break;
            } else {
//                enterprise.setInputInvoiceInvalid("none");
                enterprise.setInputInvoiceInvalid("0");
            }
        }
    }
...
//                enterprise.setOutputInvoiceInvalid("exist");
                enterprise.setOutputInvoiceInvalid("1");
                break;
            } else {
//                enterprise.setOutputInvoiceInvalid("none");
                enterprise.setOutputInvoiceInvalid("0");
            }
        }
    }
...
//            enterprise.setLossAddStock("unknown");
            enterprise.setLossAddStock("100");
        }
        ...
        if (inum > 0 && onum > 0) {
            ...
            if (time1 > 30) {
                ...
                if (inputAmount >= outputAmount && flag == true) {
                    // 设值:continuousQuarter
                    enterprise.setLossAddStock("1");
                } else {
                    enterprise.setLossAddStock("0");
                }
            } else{
                enterprise.setLossAddStock("100");
            }
...
//                detailsExtraction.setInputInvoiceBusinessScope("match");
                detailsExtraction.setInputInvoiceBusinessScope("0");
            } else {
                //不符
//                detailsExtraction.setInputInvoiceBusinessScope("inconsistent");
                detailsExtraction.setInputInvoiceBusinessScope("1");
            }
...
//                detailsExtraction.setOutputInvoiceBusinessScope("match");
                detailsExtraction.setOutputInvoiceBusinessScope("0");
            } else {
//                detailsExtraction.setOutputInvoiceBusinessScope("inconsistent");
                detailsExtraction.setOutputInvoiceBusinessScope("1");
            }
