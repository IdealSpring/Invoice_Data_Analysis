...
public class Enterprise implements Writable{
    ...
    public String toString() {
        return nsr_id +
                ...
                "," + label;
/*        return label +
                " 1:" + inputInvoiceNum + " 2:" + outputInvoiceNum +
                " 3:" + inputInvoice + " 4:" + outputInvoice +
                " 5:" + inputInterval + " 6:" + outputInterval +
                " 7:" + taxChangeRate + " 8:" + invoiceUsageChange +
                " 9:" + inputTaxAndOutputTaxRatio + " 10:" + invoiceInvalidRatio +
                " 11:" + continuousLoss + " 12:" + invoiceBalance +
                " 13:" + inputInvoiceInvalid + " 14:" + outputInvoiceInvalid +
                " 15:" + lossAddStock;*/
/*        return nsr_id + " " + label +
                " 1:" + inputInvoiceNum + " 2:" + outputInvoiceNum +
                " 3:" + inputInvoice + " 4:" + outputInvoice +
