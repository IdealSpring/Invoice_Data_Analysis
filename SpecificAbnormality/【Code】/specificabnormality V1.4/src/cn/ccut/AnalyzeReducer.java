...
public class AnalyzeReducer extends Reducer<Text, Enterprise, Enterprise, NullWritable> {
    ...
    public static List<Enterprise> enterpriseList6;
    public static List<Enterprise> enterpriseList5;
    public static List<Enterprise> enterpriseList4;
    public static List<Enterprise> enterpriseList3;
    public static List<Enterprise> enterpriseList2;
    public static List<Enterprise> enterpriseList1;
...
/*            // 按异常个数输出
            sortEnterpriseByAbnormalNum(enterprise, abnormalNum);
            OutputEnterprise.outputEnterpriseByAbnormalNum(enterpriseList6, enterpriseList5, enterpriseList4,
                    enterpriseList3, enterpriseList2, enterpriseList1);*/

            // 异常分类, 返回异常个数
            abnormalNum = Classification.abnormalClassification(enterprise);
            enterprise.setAbnormalNum(abnormalNum);

            System.out.println(enterprise.getNsr_id() + "   " +abnormalNum);
     ...
     * @param num
     */
    private static void sortEnterpriseByAbnormalNum(Enterprise enterprise, int num) {
        if (num == 6) {
            enterpriseList6.add(enterprise);
        } else if (num == 5) {
            enterpriseList5.add(enterprise);
        } else if (num == 4) {
            enterpriseList4.add(enterprise);
        } else if (num == 3) {
            enterpriseList3.add(enterprise);
        } else if (num == 2) {
            enterpriseList2.add(enterprise);
        } else if (num == 1) {
