...
public class Enterprise extends LongWritable implements Writable{
    ...
    public void write(DataOutput dataOutput) throws IOException {
        ...
        dataOutput.writeUTF(noEntryInvoice);
        dataOutput.writeUTF(noOutputInvoice);
        dataOutput.writeUTF(longTimeNoEntry);
        dataOutput.writeUTF(longTimeNoOutput);
    ...
    public void readFields(DataInput dataInput) throws IOException {
        ...
        this.noEntryInvoice = dataInput.readUTF();
        this.noOutputInvoice = dataInput.readUTF();
        this.longTimeNoEntry = dataInput.readUTF();
        this.longTimeNoEntry = dataInput.readUTF();
