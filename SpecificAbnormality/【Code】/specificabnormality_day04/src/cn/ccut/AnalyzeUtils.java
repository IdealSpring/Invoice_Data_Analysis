...
public class AnalyzeUtils {
    ...
    public static final String LOSS_WARNING_CONTINUOUS_QUARTER = "最近一季度亏损";
    ...
    public static void analyzeAbnormality(Enterprise enterprise,
        ...
        enterprise.setInvoiceUsage(analyzeInvoiceUsage(enterprise, inputInvoiceSet, outputInvoiceSet));
...
/*        enterprise.setInvoiceUsage(NO_INPUT_INVOICE);
        enterprise.setTaxChange(TAX_CHANGE);
        enterprise.setInvoiceUsageChange(INVOICE_USAGE_CHANGE);
        enterprise.setInvoiceInvalidRate(INVOICE_INVALID_RATE);
        enterprise.setLossWarning(LOSS_WARNING);*/
    }
...
// 发票进项金额
     ...
     * @return
     */
    private static String analyzeInvoiceUsage(Enterprise enterprise,
                                              TreeSet<Invoice> inputInvoiceSet,
                                              TreeSet<Invoice> outputInvoiceSet) {
...
//        long outputInvoiceNum = outputInvoiceSet.size();
        System.out.println(inputInvoiceNum);
        System.out.println(outputInvoiceNum);
        System.out.println();
